...
function validateEnv(): void {
  ...
  const required = [
    ...
    // (The external nightly-research routine + its RESEARCH_ROUTINE_TOKEN were
    // retired — prospect research now runs natively in-process; see
    // modules/marketing/research.)
